  ...
  <q-page>
    ...
    <div class="q-px-xl q-pb-xl">
        ...
        <div class="row q-col-gutter-lg justify-center">
          <div class="col-6 col-md-3 text-center animate-fade-in-up delay-1">
            <q-btn
              ...
              size="32px"
              icon="menu_book"
              class="q-mb-sm shadow-3 transition-transform hover-scale"
            />
        ...
        <div class="col-12 col-md-4 animate-fade-in-up delay-1">
          ...
          >
            <div class="row items-center justify-between q-pa-sm bg-primary text-white">
              ...
              >
                <q-btn
                  ...
                  size="sm"
                  class="q-px-sm"
                  :color="calendarMode === 'grid' ? 'white' : 'transparent'"
                  :text-color="calendarMode === 'grid' ? 'primary' : 'white'"
                  icon="grid_view"
                ...
                <q-btn
                  ...
                  size="sm"
                  class="q-px-sm"
                  :color="calendarMode === 'list' ? 'white' : 'transparent'"
                  :text-color="calendarMode === 'list' ? 'primary' : 'white'"
                  icon="view_agenda"
            ...
            <template v-if="calendarMode === 'grid'">
              <div
                class="row text-center text-weight-bold text-grey-8 bg-grey-2 q-py-xs"
              ...
              <div class="row" style="border-top: 1px solid #eee">
                ...
                >
                  <div
                    ...
                    :class="
                      (day + startDayOfWeek) % 7 === 1 ? 'text-red text-weight-bold' : 'text-grey-9'
                    "
                  >
                    {{ day }}
                  </div>
                  <template v-if="events[day]">
                    <div
                      v-for="(ev, idx) in events[day]"
                      :key="'ev' + day + idx"
                      :class="ev.color"
                      class="text-white q-px-xs q-mt-xs"
                      style="
                        border-radius: 3px;
                        font-size: 9px;
                        line-height: 1.4;
            ...
            <template v-else>
              <q-list separator class="bg-white" style="height: 310px; overflow-y: auto">
                <q-item v-for="(ev, index) in eventsList" :key="index" class="q-py-md">
                  ...
                  <q-item-section>
                    <q-item-label class="text-weight-bold text-grey-9 text-body1">{{
                      ev.title
                    }}</q-item-label>
      ...
      <section class="q-mb-md">
        <div class="text-subtitle1 text-grey-8 text-weight-bold q-mb-sm">
        ...
        <div class="row q-gutter-sm">
          ...
          <q-btn
            ...
            color="grey-7"
            icon="font_download"
            label="ดาวน์โหลด 13 ฟอนต์ราชการ"
            size="sm"
          />
          <q-btn
            flat
